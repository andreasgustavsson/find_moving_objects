...
const int         default_nr_scans_in_bank                                  = 2;
const double      default_optimize_nr_scans_in_bank                         = 0.5; // seconds
const bool        default_publish_objects                                   = true;
const bool        default_publish_ema                                       = false;
const bool        default_publish_objects_closest_points_markers            = false;
const bool        default_publish_objects_velocity_arrows                   = false;
const bool        default_publish_objects_delta_position_lines              = false;
const bool        default_publish_objects_width_lines                       = false;
